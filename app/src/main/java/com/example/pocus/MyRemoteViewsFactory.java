...
public class MyRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public void setData() {
        ...
        arrayList.add(new WidgetItem(1, "쿠팡"));
        arrayList.add(new WidgetItem(2, "무신사"));
        arrayList.add(new WidgetItem(3, "택배"));
        arrayList.add(new WidgetItem(4, "배달의민족"));
        arrayList.add(new WidgetItem(5, "로젠"));
        arrayList.add(new WidgetItem(6, "우체국"));
        arrayList.add(new WidgetItem(7, "SSG"));
        arrayList.add(new WidgetItem(8, "한진"));
        arrayList.add(new WidgetItem(9, "CJ"));
